class gmre_nor_rifleman_g3a3_80_oli : gmre_nor_oli_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_80_oli";
		scope 			= 2;
...
class gmre_nor_rifleman_g3a3_80_ols : gmre_nor_ols_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_80_ols";
		scope 			= 2;
		displayName 		= "Rifleman"; // In-game name of unit
		icon 			= "iconMan";
		weapons[] 		= {"gm_g3a3_oli","gm_ferod16_oli"}; // Weapons added to the unit.
...
class gmre_nor_rifleman_g3a3_parka_80_oli : gmre_nor_parka_oli_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_parka_80_oli";
		scope 			= 2;
		displayName 		= "Rifleman"; // In-game name of unit
		icon 			= "iconMan";
		weapons[] 		= {"gm_g3a3_oli","gm_ferod16_oli"}; // Weapons added to the unit.
...
class gmre_nor_rifleman_g3a3_parka_80_ols : gmre_nor_parka_ols_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_parka_80_ols";
		scope 			= 2;
		displayName 		= "Rifleman"; // In-game name of unit
		icon 			= "iconMan";
		weapons[] 		= {"gm_g3a3_oli","gm_ferod16_oli"}; // Weapons added to the unit.
...
class gmre_nor_rifleman_g3a3_parka_80_win : gmre_nor_parka_win_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_parka_80_win";
		scope 			= 2;
		displayName 		= "Rifleman"; // In-game name of unit
		icon 			= "iconMan";
		weapons[] 		= {"gm_g3a3_oli","gm_ferod16_oli"}; // Weapons added to the unit.
...
class gmre_nor_rifleman_g3a3_80_m75 : gmre_nor_m75_base
	{
		_generalMacro 		= "gmre_nor_rifleman_g3a3_80_m75";
		scope 			= 2;
		displayName 		= "Rifleman"; // In-game name of unit
		icon 			= "iconMan";
		weapons[] 		= {"gm_g3a3_oli","gm_ferod16_oli"}; // Weapons added to the unit.
